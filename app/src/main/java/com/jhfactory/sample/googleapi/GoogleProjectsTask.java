...
class GoogleProjectsTask extends OkHttpTask {
    ...
    private GoogleProjectsTask(Context context, @Nullable OkHttpClient client, Method method, HttpUrl url,
                               RequestBody requestBody, Bundle bundle, IHttpCallback callback) {
